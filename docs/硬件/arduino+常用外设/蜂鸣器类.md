...
# 有源蜂鸣器
![](https://raw.githubusercontent.com/dancehole/image/main/danceholeLabs/hardware-arduino-bee-3.png)
...
2. 驱动方式
   ...
   - 利用 I/O 定时翻转电平来产生驱动波形的方式会比较麻烦一点，必须利用定时器来做定时，通过定时翻转电平产生符合蜂鸣器要求的频率的波形，这个波形就可以用来驱动蜂鸣器了。比如为 2500Hz 的蜂鸣器的驱动，可以知道周期为 400μs，这样只需要驱动蜂鸣器的 I/O 口每 200μs 翻转一次电平就可以产生一个频率为2500Hz，占空比为 1/2duty 的方波，再通过三极管放大就可以驱动这个蜂鸣器了。
     ![](https://raw.githubusercontent.com/dancehole/image/main/danceholeLabs/hardware-arduino-bee-5.png)
...
如图：
![](https://raw.githubusercontent.com/dancehole/image/main/danceholeLabs/hardware-arduino-bee-4.png)
...
样子长这样：
![](https://raw.githubusercontent.com/dancehole/image/main/danceholeLabs/hardware-arduino-bee-2.png)
...
蜂鸣器对应音符 
![](https://raw.githubusercontent.com/dancehole/image/main/danceholeLabs/hardware-arduino-bee-1.png)
